...
class Estimator():
    ...
    def _build_model(self):
        ...
        conv1 = tf.contrib.layers.fully_connected(X, num_outputs=12, activation_fn=tf.nn.relu,
                                                weights_initializer=tf.contrib.layers.xavier_initializer(),
                                                biases_initializer=tf.constant_initializer(0.1))

        conv2 = tf.contrib.layers.fully_connected(conv1, num_outputs=12, activation_fn=tf.nn.relu,
                                                  weights_initializer=tf.contrib.layers.xavier_initializer(),
                                                  biases_initializer=tf.constant_initializer(0.1))
        ...
        fc1 = tf.contrib.layers.fully_connected(flattened, 12)
